				...
				if ((gridX == -1) || (gridY == -1)) {
					...
					if ((myPanel.mouseDownGridX != gridX) || (myPanel.mouseDownGridY != gridY)) {
						...
						if(!firstClick){
							...
							myPanel.setMines(gridX, gridY);
							firstClick=true;
						}
						else if(myPanel.isMineFound(gridX, gridY)&&myPanel.colorArray[myPanel.mouseDownGridX][myPanel.mouseDownGridY] != Color.RED){
						...
						else if(myPanel.countMines(gridX, gridY)>0){
							//myPanel.printMinesNum(gridX, gridY);
							myPanel.colorArray[myPanel.mouseDownGridX][myPanel.mouseDownGridY] = Color.WHITE;

							System.out.println(myPanel.countMines(gridX, gridY));
